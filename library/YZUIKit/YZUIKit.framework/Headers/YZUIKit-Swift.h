...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="YZUIKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7YZUIKit13YZActionSheet")
...
SWIFT_CLASS("_TtC7YZUIKit25YZClipImageViewController")
@interface YZClipImageViewController : UIViewController <UIScrollViewDelegate>
- (nonnull instancetype)initWithImage:(UIImage * _Nonnull)image block:(void (^ _Nonnull)(UIImage * _Nonnull))block OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7YZUIKit12YZTransition")
